function [trainedClassifier, validationAccuracy] = gaussianSVM(data)
%% gaussianSVM.m
% gaussianSVM is the "Naive" version of gaussian SVM: default 
% misclassification cost

% Extract predictors and response
%This code processes the data into the right shape for training the model.
%Convert input to table
load GaussianData.mat kernelscale boxconstraint 
rng default
...
[SVMrbfResult,SVMrbfReferenceResult] = runAllStats(validationResponse,validationPredictions);
    save GaussianResults.mat SVMrbfResult SVMrbfReferenceResult
