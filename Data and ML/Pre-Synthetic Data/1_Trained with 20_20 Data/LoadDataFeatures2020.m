% LOADDATAFEATURES Loads data from 20_20 classification (list of
% passenger/onco/tsg) and creates features to be fed into other
...
y0 = (~ismember(U_GeneName,[OncogeneList; TSGList])); %passenger mutations =1
y1 = (ismember(U_GeneName,OncogeneList)); %oncogenes = 2
y2 = (ismember(U_GeneName,TSGList));   %TSGs = 3
