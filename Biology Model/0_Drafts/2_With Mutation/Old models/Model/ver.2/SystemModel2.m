...
sol = dde23(@(t,x,Z) ODEs(t,x,Z,D1,D2,a1,a2,a3,v1,v2,v3,do,dt,k1,k2,k3,c1,c2,vmax), 2, [1,0], [0, 1.5e4]);
...
% ode file
    function dx = ODEs(t,x,Z,D1,D2,a1,a2,a3,v1,v2,v3,do,dt,k1,k2,k3,c1,c2,vmax)
        % 1) driver effects --> raises steady state # (40 to 400)
        alpha = 0.01;
        a2 = a2*(1/(1 + (dt/(do+dt))*x(2)*alpha));
        
        beta1 = 0.01; beta2 = 25;t
        v2 = v2 + (beta1 / (1 + (do/(do+dt))*x(2)/beta2)); %more x2 = more v2
        
        % ODEs
        normal cell, cancer cell, oxygen
